...
import irs.fdxtax641.jsonserializers.Tax1098CSerializer;
import irs.fdxtax641.map2objects.Map2Tax1098C;
import org.taxdataexchange.core.pdfbuilders.Tax1098CPdfBuilder;
...
public class Tax1098CDocumentGenerator {
    ...
    private void processOneRow(
        ...
        Tax1098C obj = Map2Tax1098C.generate( row );
        {
            String asJson = Tax1098CSerializer.serialize( obj );
    ...
    private void processCsvForCompany(
        ...
        // CSV file
        String csvFileName  = "Tax1098C.csv";
        ...
        String outputFileName = "Tax1098C.rows.json";
    ...
    public static void main(String[] args) {
        ...
        Tax1098CDocumentGenerator generator = new Tax1098CDocumentGenerator( );
