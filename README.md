# tax-doc-sdk-tax1098c

Software development kit to generate IRS Form 1098-C as PDF file using Financial Data Exchange (FDX) standards including QR codes and embedded JSON.

<img alt="Sample Form" src="samples/Tax1098C.sample.png" width="850"/>
